...
import Act4.service.InvestigadorServiceImpl;
...
public class InvestigadorController {
	...
	public void borrarInvestigador(@PathVariable(name = "id") Long id) {
		investigadorServiceImpl.borrarInvestigador(id);
	}
}
